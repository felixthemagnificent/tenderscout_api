class Marketplace::BidNoBidQuestionsController < ApplicationController
  ...
  private
    ...
    def marketplace_bid_no_bid_question_params
      params.require(:marketplace_bid_no_bid_question).permit(:question_text, :position, :tender_id)
    end
end
